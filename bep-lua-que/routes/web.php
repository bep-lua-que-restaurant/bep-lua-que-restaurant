...
//Phong an
Route::get('export-phong-an', [PhongAnController::class, 'exportPhongAn'])->name('phong-an.export');
Route::post('/import-phong-an', [PhongAnController::class, 'importPhongAn'])->name('phong-an.import');
