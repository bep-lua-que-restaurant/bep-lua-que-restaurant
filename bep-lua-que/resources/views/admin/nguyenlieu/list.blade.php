        ...
        <div class="row page-titles mx-0">
            ...
            <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="javascript:void(0)">Danh sách nguyên liệu</a></li>
                </ol>
            </div>
        </div>
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="btn-group">
                            ...
                            <a href="{{ route('nguyen-lieu.import') }}" class="btn btn-sm btn-secondary" data-toggle="modal"
                                data-target=".bd-example-modal-lg">
                                <i class="fa fa-download"></i> Nhập file
                            </a>

                            <a href="{{ route('nguyen-lieu.export') }}" class="btn btn-sm btn-success">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-responsive-md">
                                ...
                                <tbody id="{{ $tableId }}">
                                    @include('admin.nguyenlieu.body-list')
                                </tbody>
                            </table>
                        </div>
                    </div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <!-- Form nhập file -->
                    <form action="{{ route('nguyen-lieu.import') }}" method="POST" enctype="multipart/form-data"
                        id="importFileForm">
                        @csrf
                        <div class="mb-3">
