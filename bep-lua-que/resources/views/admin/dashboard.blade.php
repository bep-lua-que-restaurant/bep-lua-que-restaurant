						...
						<div class="card-body ">
							<div class="dz-scroll height500" id="tredingMenus">
								<div class="d-flex pb-3 mb-3 tr-row align-items-center border-bottom">
									...
									<img src="{{ asset('admin') }}/images/menu/Untitled-1.jpg"
										alt="">
								</div>
								<div class="d-flex pb-3 mb-3 tr-row align-items-center border-bottom">
									...
									<img src="{{ asset('admin') }}/images/menu/Untitled-2.jpg"
										alt="">
								</div>
								<div class="d-flex pb-3 mb-3 tr-row align-items-center border-bottom">
									...
									<div class="mr-auto pr-3">
										<a href="post-details.html">
											<h2 class="text-black fs-14 font-w500">Watermelon juice with
												ice
											</h2>
										</a>
										<span class="text-black font-w600 d-inline-block mr-3">$5.6 </span>
									...
									<img src="{{ asset('admin') }}/images/menu/Untitled-3.jpg"
										alt="">
								</div>
								<div class="d-flex pb-3 mb-3  tr-row align-items-center border-bottom">
									...
									<img src="{{ asset('admin') }}/images/menu/Untitled-4.jpg"
										alt="">
								</div>
								<div class="d-flex pb-3 mb-3 tr-row align-items-center">
									...
									<img src="{{ asset('admin') }}/images/menu/Untitled-5.jpg"
										alt="">
								</div>
							</div>
						</div>
					...
					<div class="card">
						<div class="card-header media border-0 pb-0">
							<div class="media-body d-flex">
								<div class="mr-4 mt-1">
									<svg class="card-ico" width="28" height="28"
												...
												<div class="media align-items-center">
													...
													<div class="media-body">
														<h5 class="mt-0 mb-2"><a class="text-black"
																href="ecom-product-detail.html">Sweet
																Cheezy
