    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('submit', 'form', function(e) {
                ...
                Swal.fire({
                    title: isDelete ? 'Bạn muốn ngừng sử dụng loại nguyên liệu này?' :
                        'Bạn muốn khôi phục loại nguyên liệu này?',
                    text: "Hành động này sẽ thay đổi trạng thái của loại nguyên liệu!",
                    icon: 'warning',
