...
Route::middleware(['auth'])->group(function () {
    ...
    Route::delete('/bang-luong/{id}', [BangTinhLuongController::class, 'destroy'])->name('luong.destroy');
    Route::post('/luong/chot-luong', [LuongController::class, 'chotLuong'])->name('luong.chotLuong');
    //lọc
